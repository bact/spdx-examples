...
| [04](./example04/) | Sensor/CSV | - | 1 document | 1 document | Sensor/time series data; `/Dataset/datasetType: sensor, timestamp`, `/Dataset/sensor`, `/Dataset/datasetUpdateMechanism`; **3.0→3.1**: `/Dataset/datasetSize` → `/Software/artifactSize` |
...
| [07](./example07/) | CSV + JSON | - | 1 document | 1 document | Pressure sensor calibration; `/Dataset/datasetType: numeric, structured`, `/Dataset/sensor`; SI-traceable reference data; `externalIdentifier` (DOI); **3.0→3.1**: `/Dataset/datasetSize` → `/Software/artifactSize` |
